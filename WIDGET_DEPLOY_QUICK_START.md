# 🚀 ИСТОРИЧЕСКИЙ QUICK START — Widget v3.0.2

> Исторический документ для версии v3.0.2 от августа 2026: не загружайте
> упомянутый ниже архив. Для текущей сборки используйте `build_widget.ps1`, который
> публикует `widget.zip`.
