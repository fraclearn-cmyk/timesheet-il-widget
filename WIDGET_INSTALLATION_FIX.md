# Историческое решение проблемы установки виджета amoCRM

> Историческое описание старого пакета: не загружайте упомянутый ниже архив.
> Текущая сборка `build_widget.ps1` публикует `widget.zip`.
