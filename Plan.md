...
| 1 | Единая модель данных и миграции | В работе | 2026-09-16 | Зависимость от фазы 0 закрыта; продолжается выравнивание моделей, сервисов и миграций |
...
Фаза 0 завершена с подтверждёнными ограничениями: OAuth/account/users/rights/refresh и controlled analytics spike проверены live, 110 тестов проходят, неизвестные возможности не выданы за подтверждённые. Фаза 1 снова в работе: нужно завершить единую модель, сервисы и воспроизводимые миграции.
