...
В тестовом аккаунте ещё не проверены загрузка нового `widget.zip`, доставка одноразового
...
области. Локальный jsdom smoke его не заменяет. По решению пользователя complete live
